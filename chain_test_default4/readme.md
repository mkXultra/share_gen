...
~/go/bin/ununifid keys add my_receiver --recover < mnt2.txt;
~/go/bin/ununifid keys add faucet --recover < mnt3.txt;
~/go/bin/ununifid add-genesis-account my_validator 100000000000uguu,100000000000ubtc;
~/go/bin/ununifid add-genesis-account my_receiver 100000000000uguu,100000000000ubtc;
~/go/bin/ununifid add-genesis-account faucet 100000000000uguu,100000000000ubtc,100000000000jpu;
